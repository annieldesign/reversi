...
//What to do when the server reponds that someone joined a room
...
/*if we don't already have an entry for thid peron */
...
socket.on('uninvited_response', function(payload){
    if(payload.result == 'fail'){
        alert(payload.message);
        return;
    }
